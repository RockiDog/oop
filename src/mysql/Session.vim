...
silent only
cd ~/Documents/OOP/project/oop/src/mysql
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +21 Connection.h
badd +26 Connection.cpp
badd +44 Query.h
badd +1 Query.cpp
badd +14 Insert.h
badd +1 Insert.cpp
...
badd +24 Select.h
badd +17 Select.cpp
badd +58 /usr/include/mysql++/mysql++.h
badd +150 /usr/include/mysql++/query.h
badd +158 /usr/include/mysql++/common.h
badd +114 sample.cpp
badd +0 MySQL.h
badd +0 ~/Documents/OOP/project/oop/test/mysql.cpp
badd +825 /usr/include/c++/4.8/bits/stl_iterator.h
silent! argdel *
edit Connection.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((24 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
wincmd w
argglobal
edit ~/Documents/OOP/project/oop/test/mysql.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((41 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
